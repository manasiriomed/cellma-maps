...
<title>Cellma AnyMaps - Appointment Reasons</title>
...
function livesearch(){
		...
		var url = "./AjaxUtilsAppointmentReasons.do";
		var params =  "?s=" + s;
	...
	function showMyAppReaMap(eliId, eliText){
		...
		if(dateRangeValue == ""){
			...
			var url = "./DisplayMapAjaxUtilsAppointmentReasons.do?dateRange=" + dateRangeValue + "&eliId=" + eliId + "&eliText=" +eliText;
        	location.href=url;
...
<table align="center" bgColor="#e7e7e7" width="100%" cellpadding="0" cellspacing="0">
	<tr bgColor="#FFFFFF">
		...
		<td class="slimDataHeader2" align="center" background="./images/darkGrayCenter.gif"><font color="#FFFFFF"><b>Trinidad Appointment Reasons Map</b></font></td>
						...
						<table width="100%" cellpadding="4" cellspacing="0" align="center">
							<tr bgColor="#FFFFFF">
								...
								<td width="100%" style="margin-left: auto; margin-right: auto">
									<p class="slimDataBold1">Please select your date period followed by the desired appointment reason in order to proceed.</p>
								</td>
	...
	<tr bgColor="#dde4f7">
		<td align="center" colspan="3">
			<div id="searchinfo">
				...
				<table>
					<tr>
						<td align="left" class="slimDataBold2">Date Period</td>
						<td>&nbsp;</td>
						<td class="slimDataBold2">&nbsp;Enter a Appointment Reason</td>
					</tr>
					<tr>
						<td>
							...
							<select name="dateRange" id="dateRange">
								...
								<c:if test="${not empty sessionScope.yearListAppReasons}">
								<c:forEach items="${sessionScope.yearListAppReasons}" var="y">
						...
						<td align="left">
							<input class="inputStyler" type="text" id="search" value="" onKeyUp="javascript:livesearch();"  maxlength="255" />&nbsp;&nbsp;<a style="font-size: 15px" href="javascript:clearSearch();">Clear search</a></td>
						</tr>
						<tr>
							<td onClick="javascript:clearSearch();">&nbsp;</td>
						<td onClick="javascript:clearSearch();">&nbsp;</td>
