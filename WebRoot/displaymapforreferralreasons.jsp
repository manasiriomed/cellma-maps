...
//-->	
	...
	function showMyRefReaMap(rerEliId, rerEliText){
		...
		if(dateRangeValue == ""){
			...
			var url = "./DisplayMapAjaxUtilsReferralReasons.do?dateRange=" + dateRangeValue + "&rerEliId=" + rerEliId + "&rerEliText=" +rerEliText;
	        location.href=url;
					...
					<tr>
						<td>
							<select name="dateRange" id="dateRange">
								...
								<c:if test="${not empty sessionScope.yearListRefReasons}">
								<c:forEach items="${sessionScope.yearListRefReasons}" var="y">
						...
						<td align="left"><input class="inputStyler" type="text" style="border: 1px solid #BFBFBF" id="search" value="" onKeyUp="javascript:livesearch();" maxlength="255" />&nbsp;&nbsp;<a style="font-size: 15px" href="javascript:clearSearch();">Clear search</a></td>
					</tr>
					<tr>
						<td onClick="javascript:clearSearch();">&nbsp;</td>
						<td onClick="javascript:clearSearch();">&nbsp;</td>
