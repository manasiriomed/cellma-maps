...
public class DisplayMapAjaxUtilsAppointmentReasons extends HttpServlet {
	...
	private int[][][] appointmentReasonValueForRegion(Connection con, String estId, String dateRange, int eliId, String regions[]){
	...
	private StringBuffer writeMap(Connection con, String dateRange, String estId, int eliId, String eliText, String[] regions, String[] regionsAmap, String districts[][], int populationForRegions[]){
		...
		totalsd = appointmentReasonValueForRegion(con, estId, dateRange, eliId, regions);
...
/*		    xmlData.append(" 					<background enabled=\"true\">");
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out1.println("								<td align=\"center\" width=\"100%\" style=\"margin-left: auto; margin-right: auto\"><p style=\"font-weight:bold; font-size: 15px; color: #006699; text-align: center\">Appointment Reason Selected: "+eliText+" || Date Range Selected: "+dateRange+"</td>");
